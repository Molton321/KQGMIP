...
$k\in\{2,3,4,5\}$ en una máquina de 16~GB: KQNodes en $22{,}8$~s y KGeoMIP en
$119{,}6$~s para los cuatro valores de $k$ (la preparación se comparte entre
...
completo a un promedio local sobre el bloque que de verdad se necesita. Se
recomienda KGeoMIP como estrategia por defecto (mejor tasa de acierto exacto en
$k\ge 3$), KQNodes como contraste submodular más rápido en $n$ grande, y el
clustering solo como referencia exploratoria.
...
conserva como \texttt{LegacyCostTable} y una batería de 38 tests verifica la
...
QNodes sobre el subsistema completo de N20A pasó de $365$~s a $5{,}4$~s.
...
\begin{itemize}
  ...
  perfilado mostró que la EMD es $<1\%$ del costo, por lo que Numba se reserva
  para lotes grandes.
\end{itemize}
...
en una máquina de 16~GB no caben dos. Ambas decisiones están registradas en la
bitácora con las mediciones que las sustentan.
...
sobre memoria contigua): $1{,}6$~s a $m=20$ y unos $115$~s a $m=25$ en la
...
empírico de horas proyectadas a $22{,}8$~s en N25A. Frente a la fuerza bruta
...
$115/1{,}6 \approx 72$ (el exceso es presión de caché y de memoria, coherente
con un algoritmo limitado por ancho de banda). Para QNodes, el tiempo total en
el subsistema completo creció de $5{,}4$~s ($n=20$) a $22{,}8$~s ($n=25$),
factor $4{,}2$ frente al $\approx 3{,}8$ que predice $n^3$ con $r$ acotado.
